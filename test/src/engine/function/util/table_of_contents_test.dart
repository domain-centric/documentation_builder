...
void main() {
  ...
  ''';
    ...
    test('toListWithoutLevelGabs flattens hierarchy', () {
      final links = [
        TitleLink(relativePath: 'a.md', title: 'A', level: 1),
      ...
      flat[4].level.should.be(1);
    });

    test('createTitleNodes creates correct tree', () {
      final links = [
        TitleLink(relativePath: 'a.md', title: 'A', level: 1),
        TitleLink(relativePath: 'a.md', title: 'B', level: 3),
        TitleLink(relativePath: 'a.md', title: 'C', level: 3),
      ...
      final nodes = factory.createTitleNodes(links);
      nodes.length.should.be(2);
      nodes[0].title.should.be('A');
      nodes[0].children.length.should.be(2);
      nodes[0].children[0].title.should.be('B');
      nodes[0].children[1].title.should.be('C');
      nodes[0].children[1].children.length.should.be(1);
      nodes[0].children[1].children[0].title.should.be('D');
