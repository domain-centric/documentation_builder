...
void main() {
  group('class: PubDevProject', () {
    ...
    test('field: uri', () async {
      ...
      pubDevProject.uri.toString().should.be(
    ...
    test('getter method: changeLogUri', () async {
      pubDevProject.changeLogUri.toString().should.be(
    ...
    test('getter method: exampleUri', () async {
      pubDevProject.exampleUri.toString().should.be(
    ...
    test('getter method: installUri', () async {
      pubDevProject.installUri.toString().should.be(
    ...
    test('getter method: versionsUri', () async {
      pubDevProject.versionsUri.toString().should.be(
    ...
    test('getter method: scoreUri', () async {
      pubDevProject.scoreUri.toString().should.be(
    ...
    test('getter method: licenseUri', () async {
      pubDevProject.licenseUri.toString().should.be(
