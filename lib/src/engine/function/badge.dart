...
class LabelParameter extends Parameter<String> {
  ...
  LabelParameter(Presence presence)
      : super(
          name: id,
          description: 'The label is the left text of the badge '
...
class MessageParameter extends Parameter<String> {
  ...
  MessageParameter(Presence presence)
      : super(
            name: id,
            description: 'The label is the left message is the right '
            ...
            function: (
              ...
              return Badge(
                      ...
                      image: Badge.imgShieldIoUri
                          .append(path: 'pub/v/${LocalProject.name}'),
                      link: uri)
                  .toString();
            });
}
            ...
            function: (
              ...
              Map<String, Object> parameterValues,
                ...
                Badge(
                        toolTip: parameterValues[ToolTipParameter.id] as String,
                        image: Badge.imgShieldIoUri
                            .append(path: 'pub/likes/${LocalProject.name}'),
      ...
      : super(
            ...
            function: (
              ...
              Map<String, Object> parameterValues,
                ...
                await _createStringForBadges(position, renderContext, [
                  PubPackageBadge(),
                  PubScoreBadge(),
                ]));
}
...
class GitHubWikiBadge extends ExpressionFunction {
  GitHubWikiBadge()
      : super(
            ...
            parameters: [
              ToolTipParameter(Presence.optionalWithDefaultValue(
...
Future<String> _createStringForBadges(
  ...
  var badgeResults = await Future.wait(badgeFunctions.map((b) async {
    var parametersWithOptionalValues =
        b.parameters.where((p) => p.presence.optionalWithDefaultValue);
    var parameterValues = <String, Object>{
      for (var p in parametersWithOptionalValues)
        p.name: p.presence.defaultValue as Object
    };
    return (await b.function(position, renderContext, parameterValues))
        .toString();
  }));
