...
class MergedImportFunctions extends FunctionGroup {
  ...
  static List<ExpressionFunction> createFunctions() {
    ...
    functions.addAll(
      missingImportFunctionsFromTemplateEnginePackage(functionNames),
    );
    return functions;
  }
    ...
    : super(
        ...
        parameters: [
          Parameter<String>(
            name: sourceName,
            description:
                'The project path of the code file to import'
...
class ImportDartDoc extends ExpressionFunction {
  ...
  static Future<String> readDocumentationComments(
    ...
    var foundElement = findElementRecursively(
      library,
      path.dartLibraryMemberPath!,
    );
  ...
  static void validateIfNotEmpty({
    required Result<String> documentation,
    required p.SourcePath path,
  }) {
